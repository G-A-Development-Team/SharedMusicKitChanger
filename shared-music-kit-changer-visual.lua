file.Write("\\Cache/CustomObject.lua", http.Get("https://raw.githubusercontent.com/G-A-Development-Team/SharedMusicKitChanger/main/custom-object.lua?token=GHSAT0AAAAAABWLREXWG3KVNMGYI2XK3BZGYXRRYYA"))
...
function gui.URLPlayButton(ref, var, x, y, options)
	...
	gui_text.OnClick = function(self)
		...
		print('URL ' .. vars.url)
		panorama.RunScript([[
            SteamOverlayAPI.OpenURL("]] .. vars.url .. [[")
        ]])
	end
...
function ecb_combobox_a_Changed()
	...
	print("SET: " .. kits_details[kits[gui_kits_combo:GetValue()+1]]['Round MVP anthem'])
